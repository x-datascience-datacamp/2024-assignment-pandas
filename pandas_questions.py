...
def merge_regions_and_departments(regions, departments):
    ...
    # Ensure code_dep has no leading zeros by converting it to a string
    merged["code_dep"] = merged["code_dep"].astype(str).str.lstrip("0")
...
def compute_referendum_result_by_regions(referendum_and_areas):
    ...
    return grouped[["code_reg"] + columns].set_index("code_reg")
