...
def merge_regions_and_departments(regions, departments):
    ...
    regions_and_departments = pd.merge(departments, regions, on='code_reg', how='inner')
...
def plot_referendum_map(referendum_result_by_regions):
    ...
    * Return a gpd.GeoDataFrame with a column 'ratio' containing the results.
    ...
    merged = regions_geo.merge(referendum_result_by_regions, left_on='code', right_on='code_reg', how='left')

    merged['ratio'] = merged['Choice A'] / (merged['Choice A'] + merged['Choice B'] + merged['Null'])
