...
def merge_regions_and_departments(regions, departments):
    ...
    regions_and_departments = pd.merge(regions, departments, on='code_reg',how='left')
...
def merge_referendum_and_areas(referendum, regions_and_departments):
    ...
    referendum_and_areas = pd.merge(referendum,regions_and_departments, on='code_dep',how='inner')
    referendum_and_areas = referendum_and_areas.rename(columns={
        'name_dep_x':'name_dep'
    })
    

    referendum_and_areas = referendum_and_areas[['Department code', 'Department name', 'Town code', 'Town name',
...
def compute_referendum_result_by_regions(referendum_and_areas):
    ...
    referendum_results = referendum_and_areas.groupby(['code_reg','name_reg']).sum()
