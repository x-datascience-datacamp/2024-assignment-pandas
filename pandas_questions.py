...
def merge_referendum_and_areas(referendum, regions_and_departs):
    ...
    # Convert single-digit department codes by removing leading zeros
    regions_and_departs["code_dep"] = regions_and_departs["code_dep"].replace(
        {
            "01": "1",
            "02": "2",
            "03": "3",
