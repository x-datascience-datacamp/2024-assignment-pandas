...
def load_data():
    ...
    """
    referendum = pd.read_csv("data/referendum.csv", on_bad_lines="skip", delimiter=";")
...
def merge_regions_and_departments(regions, departments):
    ...
    merged_data = departments.merge(regions, how="left", on="region_code")
    merged_data.rename(
        columns={
            "code": "code_dep",
    ...
    merged_data = merged_data[["code_reg", "name_reg", "code_dep", "name_dep"]]
    return merged_data
...
def plot_referendum_map(referendum_result_by_regions):
    ...
    * Return a gpd.GeoDataFrame with a column 'ratio' containing the results.
    ...
    merged_df.plot(column="ratio", cmap="Greens", legend=True, ax=ax, edgecolor="black")
